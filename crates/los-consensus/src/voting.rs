// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// UNAUTHORITY (LOS) - QUADRATIC VOTING
//
...
/// Calculate voting power using quadratic formula: √(stake in CIL)
///
...
pub fn calculate_voting_power(staked_amount_cil: u128) -> u128 {
    ...
    let clamped_stake = staked_amount_cil.min(MAX_STAKE_FOR_VOTING_CIL);
    isqrt(clamped_stake)
}
...
mod tests {
    ...
    fn test_anti_whale_effectiveness() {
        // Scenario 1: Single whale with 10000 LOS
        let whale_stake = 10_000 * LOS;
        let whale_power = calculate_voting_power(whale_stake);

        // Scenario 2: 10 nodes with 1000 LOS each (minimum stake)
