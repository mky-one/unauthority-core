...
pub struct AntiWhaleConfig {
    ...
    pub max_burn_per_block: u64,   // Max LOS burned per block per address
}
...
impl AntiWhaleEngine {
    ...
    pub fn get_concentration_stats(&self, validators: BTreeMap<String, u64>) -> ConcentrationStats {
        ...
        ConcentrationStats {
            ...
            top_3_bps: ((top_3_stake as u128 * 10_000) / total_stake as u128) as u64,
            top_10_bps: ((top_10_stake as u128 * 10_000) / total_stake as u128) as u64,
...
pub struct ConcentrationStats {
    ...
    pub total_stake: u64,
    /// Top 3 validators stake share in basis points (10000 = 100%)
    pub top_3_bps: u64,
    /// Top 10 validators stake share in basis points (10000 = 100%)
    pub top_10_bps: u64,
...
mod tests {
    ...
    fn test_concentration_stats() {
        ...
        // top 3 = 18000/20000 = 9000 bps (90%)
        assert!(stats.top_3_bps > 0);
    }
