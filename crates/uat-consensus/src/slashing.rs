...
impl SlashingManager {
    ...
    pub fn slash_double_signing(
        ...
        let slash_amount = staked_amount_void; // 100% slash
    ...
    pub fn get_safety_stats(&self) -> SafetyStats {
        ...
        SafetyStats {
            ...
            banned_count,
            slashed_count,
            total_slashed_void: total_slashed,
...
mod tests {
    ...
    fn test_double_signing_slash() {
        ...
        let staked = 100_000_000_000u128; // 1000 UAT
    ...
    fn test_total_slashed_calculation() {
        ...
        let staked1 = 100_000_000_000u128; // 1000 UAT
