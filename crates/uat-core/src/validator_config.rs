...
impl ValidatorConfig {
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        if self.address.is_empty() || !self.address.starts_with("UAT") {
    ...
    fn test_validator_config_creation() {
        let config = ValidatorConfig {
            ...
            sentry_private: SentryPrivateConfig {
                listen_addr: "127.0.0.1".to_string(),
                listen_port: 31333,
                psk_file: "/etc/uat/signer.psk".to_string(),
            },
        };
    ...
    fn test_validator_manager() {
        ...
        let config1 = ValidatorConfig {
            ...
            sentry_private: SentryPrivateConfig {
                listen_addr: "127.0.0.1".to_string(),
                listen_port: 31333,
                psk_file: "/etc/uat/1/signer.psk".to_string(),
            },
        };
        ...
        let config2 = ValidatorConfig {
            ...
            sentry_private: SentryPrivateConfig {
                listen_addr: "127.0.0.1".to_string(),
                listen_port: 31334,
                psk_file: "/etc/uat/2/signer.psk".to_string(),
            },
        };
