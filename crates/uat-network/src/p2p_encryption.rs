...
impl SignerNode {
    ...
    /// Sign message and send encrypted
    pub fn sign_and_send(
        &mut self,
        message: &str,
        _signature: Vec<u8>, // Would normally sign here
    ...
    pub fn is_connected_to_sentry(&self) -> bool {
        self.sentry_tunnel.is_some()
            && self
                .active_sessions
                .get(self.sentry_tunnel.as_ref().unwrap())
...
mod tests {
    ...
    fn test_signer_node_creation() {
        ...
        let signer = SignerNode::new(
            ...
            "UAT_validator_address".to_string(),
            1000,
        )
        .unwrap();
