...
impl SlashingManager {
    ...
    pub fn slash_double_signing(
        ...
        if let Some(profile) = self.validator_profiles.get_mut(validator_address) {
            ...
            // Execute 100% slash
            let slash_amount = current_stake_void;
            ...
            self.total_network_slash_void += slash_amount;
    ...
    pub fn get_statistics(&self) -> SlashingStatistics {
        ...
        SlashingStatistics {
            ...
            total_violations,
            total_slashed_void: self.total_network_slash_void,
