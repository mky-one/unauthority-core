// Transaction Mempool for UAT Node
// 
...
impl Mempool {
    ...
    pub fn add_transaction(&mut self, block: Block, fee: u64, priority: u64) -> Result<String, String> {
    ...
    pub fn remove_expired(&mut self) -> usize {
        ...
        let expired: Vec<String> = self.transactions
            .iter()
