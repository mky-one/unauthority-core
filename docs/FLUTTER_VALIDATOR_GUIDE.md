...
Go to **[GitHub Releases](https://github.com/mky-one/unauthority-core/releases)** and download the latest version for your platform:
...
| **Formula** | `reward_i = budget × √(stake_i) / Σ√(stake_all)` |
| **Min Stake** | 1,000 LOS |
| **Min Uptime** | 95% |

> **Anti-Whale:** Quadratic voting (√stake) means diminishing returns for large stakes. A whale with 100× your stake only gets 10× the rewards.
...
1. Download the latest release from [GitHub Releases](https://github.com/mky-one/unauthority-core/releases)
