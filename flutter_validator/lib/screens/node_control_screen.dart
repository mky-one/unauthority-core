        ...
        child: Column(
          ...
          children: [
            const Row(children: [
              ...
              SizedBox(width: 8),
              Text('Node Details', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ]),
            const Divider(),
            ...
            if (node.nodeAddress != null)
              _infoTapRow('Node Address', _shortAddr(node.nodeAddress!), node.nodeAddress!),
            ...
            if (node.dataDir != null)
              _infoRow('Data Dir', node.dataDir!),
          ],
        ),
      ),
    );
    ...
    return Card(
      child: Column(children: [
        ListTile(
          ...
          title: const Text('Node Logs', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    if (line.contains('ERR')) {
                      color = Colors.red;
                    } else if (line.contains('ready') || line.contains('running')) {
                      color = Colors.green;
                    } else if (line.contains('restart') || line.contains('warning')) {
                      color = Colors.amber;
                    }
                    return Padding(
          ...
          children: [
            ...
            if (_balance != null)
              Container(
                ...
                decoration: BoxDecoration(
                  color: _balance! >= 1000 ? Colors.green.withValues(alpha: 0.1) : Colors.red.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(8)),
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Icon(_balance! >= 1000 ? Icons.check_circle : Icons.warning,
                    size: 16, color: _balance! >= 1000 ? Colors.green : Colors.red),
                  const SizedBox(width: 6),
                  Text(
                    _balance! >= 1000 ? 'Active Validator (Stake >= 1,000 UAT)' : 'Insufficient Stake',
        ...
        child: Column(
          ...
          children: [
            const Row(children: [
              ...
              SizedBox(width: 8),
              Text('Network', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ]),
            const Divider(),
            Consumer<NetworkStatusService>(
              builder: (context, net, _) => Column(children: [
                _infoRow('Status', net.isConnected ? 'Connected' : 'Disconnected'),
      ...
      child: Row(
        ...
        children: [
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            Text(displayValue,
              style: const TextStyle(fontWeight: FontWeight.w600, fontFamily: 'monospace', fontSize: 12)),
