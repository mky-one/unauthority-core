...
//
// Tests integer-only math and Quadratic Voting isqrt
// to ensure backend-matching behavior.
...
void main() {
  ...
  group('isqrt (Integer Square Root)', () {
    ...
    test('isqrt matches quadratic voting: sqrt(1000 LOS stake)', () {
      // Validator with 1000 LOS → voting power = isqrt(1000) = 31
      expect(BlockchainConstants.isqrt(1000), 31);
    });
  });
