...
cd node_a_data
../target/release/los-node 3030 > ../node_a.log 2>&1 &
NODE_A_PID=$!
cd ..
...
cd node_b_data
../target/release/los-node 3031 > ../node_b.log 2>&1 &
NODE_B_PID=$!
cd ..
...
cd node_c_data
../target/release/los-node 3032 > ../node_c.log 2>&1 &
NODE_C_PID=$!
cd ..
